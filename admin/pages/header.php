...
<head>
    ...
    <title>Global | <?php echo $portal;?></title>
...
<!-- Bootstrap  fabric.js -->
<script src="../vendor/bootstrap/js/fabric.min.js"></script>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Global | <?php echo $portal;?></a>
            </div>
            <!-- /.navbar-header -->
